...
add_settings_field(
	...
	array(
		...
		array(
			'type'         => 'helper_description',
			'name'         => 'ssl_cache_desc',
			'description'  => __( 'SSL cache works best when your entire website runs on HTTPS.', 'rocket' ),
		),
	)
);
...
$rocket_purge_fields[] = array(
	...
	'description'  => __( 'Reduce lifespan to 10 hours or less if you notice issues with forms, nonces (secret tokens) and others that seem to appear periodically.', 'rocket' ),
);
