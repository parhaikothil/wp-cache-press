...
function rocket_parse_url_domain_mapping( $url ) {
	$original_siteurl_host       = rocket_parse_url( get_original_url( 'siteurl' ), PHP_URL_HOST );
	$domain_mapping_siteurl_host = rocket_parse_url( domain_mapping_siteurl( false ), PHP_URL_HOST );
